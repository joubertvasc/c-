...
namespace NETMeter
{
	...
	public class About : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelAppName.Text = "NETMeter";
			// 
			// pictureBox1
			// 
			...
			this.labelAppCopyright.Size = new System.Drawing.Size(312, 40);
			this.labelAppCopyright.TabIndex = 1;
			this.labelAppCopyright.Text = "Copyright (c) Alessandro Fragnani\nBased on original MyDUMeter from leepie (http:/" +
				"/www.codeproject.com/csharp/mydumeter.asp)";
			// 
			// label1
			// 
			...
			this.label2.Text = "This application is provided \"as is\". Use it at your own risk. It´s freely availa" +
				"ble to anyone that wants an easy to use network bandwidth monitor.";
			// 
			// linkLabelEmail
			// 
		...
		{
			System.Diagnostics.Process.Start("mailto:" + linkLabelEmail.Text + "?subject=NETMeter");
		}
	}
}
