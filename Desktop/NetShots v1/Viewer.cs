...
namespace PictureViewer
{
	...
	public class Viewer : System.Windows.Forms.UserControl
	{
		...
		private void RatioStretch()
		{
			...
			{	
				// AFM - Added the possibility to resize the image to "fit the area" if the area is bigger 
				//       than the image
...
//				this.pictureBox1.Height = this.pictureBox1.Image.Height;				
				...
				{
					//width image
					if ( this.Width >= this.Height && imRatio >= pRatio )
					{
					...
					{							
						this.pictureBox1.Height = this.pictureBox1.Image.Height;
						this.pictureBox1.Width = (int)(this.pictureBox1.Image.Height * imRatio);
					}					
				}
				else
				{
