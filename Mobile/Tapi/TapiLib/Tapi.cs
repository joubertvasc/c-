...

{
	...
	public class Tapi
	{
		...
		public Line CreateLine(int deviceID, LINEMEDIAMODE mode, LINECALLPRIVILEGE priv)
		{
            ...
            int lpdwExtVersion = 0;
            int ret2 = NativeTapi.lineNegotiateExtVersion(m_hLineApp, deviceID, NegotiateVersion(deviceID), 0x00010000, 0x00010000, out lpdwExtVersion);
...
//				Dispose();
	...
	public class NativeTapi
	{
        ...
        public static extern int lineNegotiateExtVersion(
            IntPtr hLineApp, 
            int dwDeviceID, 
            int dwAPIVersion, 
            int dwExtLowVersion, 
            int dwExtHighVersion, 
            out int lpdwExtVersion);
	}
    ...
    public static class TapiLineErr
    {
        public static uint LINEERR_INVALLINEHANDLE = 0x8000002B;
        public static uint LINEERR_NOMEM = 0x80000044;
        public static uint LINEERR_OPERATIONUNAVAIL = 0x80000049;
        public static uint LINEERR_OPERATIONFAILED = 0x80000048;
        public static uint LINEERR_RESOURCEUNAVAIL = 0x8000004B;
        public static uint LINEERR_INVALPOINTER = 0x80000035;
        public static uint LINEERR_INVALPARAM = 0x80000032;
        public static uint LINEERR_UNINITIALIZED = 0x80000050;

        public static uint LINEERR_BADDEVICEID = 0x00000002;
        public static uint LINEERR_INCOMPATIBLEAPIVERSION = 0x8000000C;
        public static uint LINEERR_NODRIVER = 0x80000043;
        public static uint LINEERR_INCOMPATIBLEEXTVERSION = 0x8000000D;
        public static uint LINEERR_INVALAPPHANDLE = 0x80000014;
        public static uint LINEERR_NODEVICE = 0x80000042;
    }
