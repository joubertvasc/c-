...
namespace JVUtils
{
    public class ZipStorer
    {
        ...
        // Constructor
        public ZipStorer(string _filename, string _comment)
        {
            this.FileName = _filename;
            this.Comment = _comment;
            this.ZipFileStream = new FileStream(_filename, FileMode.Create, FileAccess.ReadWrite);
        }
        ...
        // Updates central directory and close
        public void Close()
        {
        ...
        */
        private void WriteEndRecord(uint size, uint offset)
        {
            ...
            this.ZipFileStream.Write(BitConverter.GetBytes((ushort)Files.Count), 0, 2);
            this.ZipFileStream.Write(BitConverter.GetBytes((ushort)Files.Count), 0, 2);
