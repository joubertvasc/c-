...
using JVUtils.Compress.Encryption;
#endif

using JVUtils.Compress.Core;
using JVUtils.Compress.Checksums;
using JVUtils.Compress.Zip.Compression.Streams;
using JVUtils.Compress.Zip.Compression;

namespace JVUtils.Compress.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="JVUtils.Compress.Zip.ZipException">
