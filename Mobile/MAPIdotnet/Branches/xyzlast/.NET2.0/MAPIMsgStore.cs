...
namespace MAPIdotnet
{
    internal class MAPIMsgStore : MAPIProp, IMAPIMsgStore
    {
        ...
        public void DisplayComposeDialog(string recipients, string subject) { MessagingApplication.DisplayComposeForm(this.DisplayName, recipients, subject); }
        ...
        public void DisplayComposeDialog(IMAPIContact[] recipients) { DisplayComposeDialog(recipients, ""); }
        public void DisplayComposeDialog(IMAPIContact[] recipients, string subject)
        {
            ...
            MessagingApplication.DisplayComposeForm(this.DisplayName, recips.ToString(), subject);
        }
