...
namespace MAPIdotnet
{
    ...
    {
        public enum OpenPropertyFlags : uint
        {
            Default = 0,
        ...
        public interface IMAPIProp : IMAPIUnknown
        {
            ...
            IStream OpenProperty(PropTags tag, OpenPropertyFlags flags);
        }
        ...
        private abstract class MAPIProp : MAPIUnknown, IMAPIProp
        {
            ...
            private static extern HRESULT pIMAPIPropOpenProperty(IntPtr prop, uint ulPropTag, uint flags, ref IStream lppUnk);
            ...
            public IStream OpenProperty(PropTags tag, OpenPropertyFlags flags)
            {
                IStream stream = null;
                HRESULT hr = pIMAPIPropOpenProperty(this.ptr, (uint)tag, (uint)flags, ref stream);
                if (hr == HRESULT.MAPI_E_NOT_FOUND)
                    return null;
                if (hr != HRESULT.S_OK)
                    throw new Exception("pIMAPIPropOpenProperty failed: " + hr.ToString());
