...
namespace MAPIdotnet
{
    ...
    {
        [Flags]
        private enum CreateFolderFlags : uint
        {
            MAPI_UNICODE        = 0x80000000,
            OPEN_IF_EXISTS      = 0x00000001,
        }
        [Flags]
        private enum DeleteFolderFlags : uint
        {
        ...
        public enum PropTags : uint
        {
            ...
            PR_ATTACHMENT_X400_PARAMETERS               = PT.PT_BINARY |    0x3700 << 16,
            ...
            PR_ATTACH_EXTENSION_W                       = PT.PT_UNICODE |   0x3703 << 16,
            PR_ATTACH_EXTENSION_A                       = PT.PT_STRING8 |   0x3703 << 16,
            PR_ATTACH_FILENAME                          = PT.PT_TSTRING |   0x3704 << 16,
            PR_ATTACH_FILENAME_W                        = PT.PT_UNICODE |   0x3704 << 16,
            PR_ATTACH_FILENAME_A                        = PT.PT_STRING8 |   0x3704 << 16,
            PR_ATTACH_METHOD                            = PT.PT_LONG |      0x3705 << 16,
            PR_ATTACH_LONG_FILENAME                     = PT.PT_TSTRING |   0x3707 << 16,
            PR_ATTACH_LONG_FILENAME_W                   = PT.PT_UNICODE |   0x3707 << 16,
            PR_ATTACH_LONG_FILENAME_A                   = PT.PT_STRING8 |   0x3707 << 16,
            PR_ATTACH_PATHNAME                          = PT.PT_TSTRING |   0x3708 << 16,
            PR_ATTACH_PATHNAME_W                        = PT.PT_UNICODE |   0x3708 << 16,
            PR_ATTACH_PATHNAME_A                        = PT.PT_STRING8 |   0x3708 << 16,
            ...
            PR_ATTACH_TRANSPORT_NAME_W                  = PT.PT_UNICODE |   0x370C << 16,
            PR_ATTACH_TRANSPORT_NAME_A                  = PT.PT_STRING8 |   0x370C << 16,
            PR_ATTACH_LONG_PATHNAME                     = PT.PT_TSTRING |   0x370D << 16,
            PR_ATTACH_LONG_PATHNAME_W                   = PT.PT_UNICODE |   0x370D << 16,
            PR_ATTACH_LONG_PATHNAME_A                   = PT.PT_STRING8 |   0x370D << 16,
            PR_ATTACH_MIME_TAG                          = PT.PT_TSTRING |   0x370E << 16,
            PR_ATTACH_MIME_TAG_W                        = PT.PT_UNICODE |   0x370E << 16,
            PR_ATTACH_MIME_TAG_A                        = PT.PT_STRING8 |   0x370E << 16,
        ...
        [DllImport("cemapi.dll")]
        private static extern uint MailDisplayMessage(IntPtr lpEntryID, uint cbEntryID);

        private static byte[] EntryIDFromPtr(IntPtr ptr)
        {
            int cbEntryID = Marshal.ReadInt32(ptr);
            byte[] entryID = new byte[cbEntryID];
            IntPtr lpEntryID = Marshal.ReadIntPtr((IntPtr)((uint)ptr + 4));
            Marshal.Copy(lpEntryID, entryID, 0, cbEntryID);
            return entryID;
        }
