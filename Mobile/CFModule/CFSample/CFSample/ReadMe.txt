================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : CFSample Project Overview
===============================================================================

The application wizard has created this CFSample application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your CFSample application.
...
CFSample.h
    ...
    project specific headers and declares the CCFSampleApp application class.
...
CFSampleDlg.h, CFSampleDlg.cpp - the dialog
    These files contain your CCFSampleDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named CFSample.pch and a precompiled types file named StdAfx.obj.
